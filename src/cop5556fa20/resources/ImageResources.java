...
public class ImageResources {
	...
	public static final String fileImage0 = "src/resource/gatorfootball.png";
	//fileImage1 should be a fully qualified file name of an image on your local file system.
	public static final String fileImage1 = "src/resource/floridagator.png";
	...
	public static final String binDir="output/production/COP5556-CourseProject_CompilerImplementation/cop5556fa20";
}	
