...
public class PixelOps
{
	...
	public static void clearGlobalLog() { globalLog.clear(); }
	...
	public static final int[] BITMASKS = {SELECT_ALPHA, SELECT_RED, SELECT_GRN, SELECT_BLU, },
		...
		public static int getRed(int pixel) {
			globalLog.add((pixel & SELECT_RED) >>> SHIFT_RED);
		...
		public static int getGreen(int pixel) {
			globalLog.add((pixel & SELECT_GRN) >>> SHIFT_GRN);
		...
		public static int getBlue(int pixel) {
			globalLog.add((pixel & SELECT_BLU) >>> SHIFT_BLU);
